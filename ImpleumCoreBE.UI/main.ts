...
app.on('ready', () => {
  if (serve) {
    console.log("Impleum Core BE UI was started in development mode. This requires the user to be running the Impleum Full Node Daemon himself.")
  }
  else {
...
function createTray() {
  ...
  systemTray.setToolTip('Impleum Core BE');
